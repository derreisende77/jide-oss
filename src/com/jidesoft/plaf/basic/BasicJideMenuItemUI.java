 ...
 */
public class BasicJideMenuItemUI extends MenuItemUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new BasicJideMenuItemUI();
    }
    ...
    public void uninstallUI(JComponent c) {
        ...
        if ((parent != null && parent instanceof JComponent) &&
            ...
            p.putClientProperty(BasicJideMenuItemUI.MAX_ACC_WIDTH, null);
            p.putClientProperty(BasicJideMenuItemUI.MAX_TEXT_WIDTH, null);
        }
    ...
    protected Dimension getPreferredMenuItemSize(JComponent c,
        ...
        if (parent != null && parent instanceof JComponent &&
            ...
            Integer maxTextWidth = (Integer) p.getClientProperty(BasicJideMenuItemUI.MAX_TEXT_WIDTH);
            Integer maxAccWidth = (Integer) p.getClientProperty(BasicJideMenuItemUI.MAX_ACC_WIDTH);
            ...
            if (r.width < maxTextValue) {
                ...
                p.putClientProperty(BasicJideMenuItemUI.MAX_TEXT_WIDTH, r.width);
            }

            //Compare the accelerator widths.
            if (acceleratorRect.width > maxAccValue) {
                maxAccValue = acceleratorRect.width;
                p.putClientProperty(BasicJideMenuItemUI.MAX_ACC_WIDTH, acceleratorRect.width);
            }
...
//        }
    ...
    protected void paintText(Graphics g, JMenuItem menuItem, Rectangle textRect, String text) {
        ...
        if (!model.isEnabled()) {
            ...
            Color color = getDisabledTextColor(menuItem);
            if (color == null) {
            ...
            if (model.isArmed()) {
                ...
                if (shadow == null) {
                    shadow = menuItem.getBackground().darker();
                }
                g.setColor(shadow);
            ...
            if (color == null) {
                color = menuItem.getBackground().brighter();
            }
            g.setColor(color);
            JideSwingUtilities.drawStringUnderlineCharAt(menuItem, g, text, mnemonicIndex,
